...
public class InfoWindow extends ItemDetailsWindow {
	...
	protected void init() {
		...
		String priceLabelStr = "<p><span class='bold'>" + translator.localize("Description.Price") + ":</span><br/>" + Integer.toString((int)subscriptionCostItem.getPrice()) + " " + translator.localize("Description.Euro") + "</p>";
